...
typedef std::function<void(char* topic, char* payload, uint8_t qos, size_t len, size_t index, size_t total)> OnMessageUserCallback;
...
typedef std::function<void(char* topic, char* payload, uint8_t qos, size_t len, size_t index, size_t total, uint16_t packetId)> OnMessageInternalCallback;
