...
void UnsubAckPacket::parseVariableHeader(const char* data, size_t len, size_t* currentBytePosition) {
...
void UnsubAckPacket::parsePayload(const char* data, size_t len, size_t* currentBytePosition) {
  (void)data;
