...
void ConnAckPacket::parseVariableHeader(const char* data, size_t len, size_t* currentBytePosition) {
...
void ConnAckPacket::parsePayload(const char* data, size_t len, size_t* currentBytePosition) {
  (void)data;
