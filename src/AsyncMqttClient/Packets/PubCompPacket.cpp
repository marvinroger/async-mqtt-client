...
void PubCompPacket::parseVariableHeader(const char* data, size_t len, size_t* currentBytePosition) {
...
void PubCompPacket::parsePayload(const char* data, size_t len, size_t* currentBytePosition) {
  (void)data;
